    ...
    function $updateTextNodeFromDOMContent(textNode, textContent, anchorOffset, focusOffset, compositionEnd) {
      ...
      if (node.isAttached() && (compositionEnd || !node.isDirty())) {
        ...
        if (compositionEnd || normalizedTextContent !== prevTextContent) {
          ...
          if (node.isToken() || compositionKey !== null && nodeKey === compositionKey && !isComposing || parent !== null && $isRangeSelection(prevSelection) && !parent.canInsertTextBefore() && prevSelection.anchor.offset === 0) {
            node.markDirty();
            return;
          }
          const selection = $getSelection();
...
//# sourceMappingURL=chunk-6YXZU43S.js.map
